$( document ).ready(function() {
    function GetDrugsData() {
        $(function () {
            $.ajax({
                type: "GET",
                url: "/Style%20Library/IDF_Branding/js/drugs_1.txt",
                data: '{}',
        ...
        function OnSuccess(response) {
            ...
            var t = $("#table_id").DataTable({
                ...
                "columnDefs": [ {
                    "targets": 16,
                    "data": null,
                    "defaultContent": "<button type='button' class='viewD'><img src='/Style%20Library/IDF_Branding/img/viewD.svg' /></button>"
                } ],
                initComplete: function () {
                    ...
                    $('#table_id tfoot tr').append( "<button type='button' class='initSearch'><img src='/Style%20Library/IDF_Branding/img/search.svg' /></button>" );
                }
            });
            ...
            $('#table_id tbody').on( 'click', 'button', function () {
                ...
                <ul>
                    ...
                    <li><strong>Appendix</strong> <span>${cellNum.eq(15).html() ? '<a target="_blank" href="http://10.3.234.6/Style%20Library/IDF_Branding/PDF/' + cellNum.eq(15).html() + '.pdf"><img src="/Style%20Library/IDF_Branding/img/pdf.svg" /></a>' : '...'}</span></li>
